<%@ Page Title="Редактирование аттракциона" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditAttractions.aspx.cs" Inherits="ParkPeace.Pages.PagesAttractions.EditAttractions" %>
